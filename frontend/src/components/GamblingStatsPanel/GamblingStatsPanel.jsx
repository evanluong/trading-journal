import styles from './GamblingStatsPanel.module.css'
...
export default function GamblingStatsPanel({ stats }) {
  ...
  return (
    <div className={styles.panel}>
      ...
      <StatCard label="Best Session"   value={`+$${stats.best}`}                            tone="profit" />
      <StatCard label="Total Sessions" value={stats.count}                                  tone="neutral" />
    </div>
  )
}
